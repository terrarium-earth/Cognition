...
import com.cyanogen.cognition.renderer.MolecularMetamorpherItemRenderer;
...
public class MolecularMetamorpherItem extends BlockItem implements GeoItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if(tag.contains("isEmpty") && !tag.getBoolean("isEmpty")){
            tooltipComponents.add(Component.translatable("tooltip.cognition.molecular_metamorpher.has_contents"));
        }
