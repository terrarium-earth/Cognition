...
import static com.cyanogen.experienceobelisk.utils.RecipeUtils.getCatalysts;
...
public class InfectingCategory implements IRecipeCategory<InfectingRecipe> {
    ...
    public IDrawable getBackground() {
        return guiHelper.createDrawable(infectingBackground, 0, 0, 136, 66);
    }
    ...
    public List<Component> getTooltipStrings(InfectingRecipe recipe, IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
        ...
        getCounterArrowTooltip(recipe.getInfectionCount(), tooltip, mouseX, mouseY);
        return tooltip;
    }
