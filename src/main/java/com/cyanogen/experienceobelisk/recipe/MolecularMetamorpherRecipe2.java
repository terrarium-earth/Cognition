...
public class MolecularMetamorpherRecipe2 implements Recipe<SimpleContainer> {
    ...
    public MolecularMetamorpherRecipe2(ArrayList<Tuple<Ingredient, Integer>> ingredients, ItemStack output, int cost, int processTime, ResourceLocation id){
    ...
    public static class Type implements RecipeType<MolecularMetamorpherRecipe2>{
    ...
    public static class Serializer implements RecipeSerializer<MolecularMetamorpherRecipe2> {

        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ExperienceObelisk.MOD_ID, "molecular_metamorphosis");

        @Override
        public MolecularMetamorpherRecipe2 fromJson(ResourceLocation id, JsonObject recipe) {
            ...
            return new MolecularMetamorpherRecipe2(ingredients, result, cost, processTime, id);
        }

        @Override
        public @Nullable MolecularMetamorpherRecipe2 fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, MolecularMetamorpherRecipe2 recipe) {
